...
{
  // we don't need to configure the timer, as it is already done by the
  // wrapper, don't we?
  // enable the trigger command in the timer  ? 
  //
...
{
  // just disable the trigger of the timer  ?
  //
