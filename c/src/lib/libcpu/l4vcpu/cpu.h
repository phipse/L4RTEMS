...
#define i386_outport_byte( _port, _value ) \
do { l4rtems_outport( _port, _value, 0 ); \
  } while (0) 

#define i386_outport_word( _port, _value ) \
do { l4rtems_outport( _port, _value, 1 ); \
   } while (0)

#define i386_outport_long( _port, _value ) \
do { l4rtems_outport( _port, _value, 2); \
   } while (0)

#define i386_inport_byte( _port, _value ) \
do { _value = l4rtems_inport( _port, 0 ); \
   } while (0)

#define i386_inport_word( _port, _value ) \
do { _value = l4rtems_inport( _port, 1 ); \
   } while (0)
